...
export interface ApiAboutUsHeroSectionAboutUsHeroSection
  ...
  info: {
    description: '';
    displayName: 'about-us-hero-section';
...
export interface ApiCustomerJourneyCustomerJourney
  extends Struct.CollectionTypeSchema {
  collectionName: 'customer_journeys';
  info: {
    description: '';
    displayName: 'customer-journey';
    pluralName: 'customer-journeys';
    singularName: 'customer-journey';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    journey_cards: Schema.Attribute.Relation<
      'oneToMany',
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::customer-journey.customer-journey'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiDashboardContactSectionDashboardContactSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'dashboard_contact';
  info: {
    description: '';
    displayName: 'dashboard-contact-section';
    pluralName: 'dashboard-contact';
    singularName: 'dashboard-contact-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::dashboard-contact-section.dashboard-contact-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiDashboardTeamSectionDashboardTeamSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'dashboard_team';
  info: {
    displayName: 'dashboard-team-section';
    pluralName: 'dashboard-team';
    singularName: 'dashboard-team-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    left_section: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::dashboard-team-section.dashboard-team-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    right_section: Schema.Attribute.JSON;
    right_section_counts: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDashboardDashboard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer_journey: Schema.Attribute.Relation<
      'oneToOne',
      'api::customer-journey.customer-journey'
    >;
    dashboard_contact_section: Schema.Attribute.Relation<
      'oneToOne',
      'api::dashboard-contact-section.dashboard-contact-section'
    >;
    dashboard_team_section: Schema.Attribute.Relation<
      'oneToOne',
      'api::dashboard-team-section.dashboard-team-section'
    >;
...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    company_links: Schema.Attribute.JSON;
    ...
    copyright_text: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u00A9 Copyright Squadra Media Private Limited 2021. All rights reserved'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    terms_of_service_link: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dashboard-contact-section.dashboard-contact-section': ApiDashboardContactSectionDashboardContactSection;
      'api::dashboard-team-section.dashboard-team-section': ApiDashboardTeamSectionDashboardTeamSection;
